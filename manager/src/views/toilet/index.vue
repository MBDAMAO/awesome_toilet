<template>
    ...
    <Container class="flex flex-col">
        ...
        <div class="flex mb-4 gap-4">
            <el-input v-model="queryParams.name" placeholder="搜索厕所名称" clearable style="width: 200px"
                @clear="fetchToiletList" @keyup.enter="fetchToiletList" />
...
import { getToiletList, deleteToilet } from '@/apis/toilet'
...
const confirmDelete = async () => {
    ...
    try {
        ...
        await deleteToilet(currentToilet.value.id)
